...
import com.example.quiz.models.FileParser
import com.example.quiz.models.QuizSQLHelper
import com.example.quiz.models.User
import com.example.quiz.services.DatabaseManager
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startQuiz() {
        ...
        if (FirstNameInput.text.isNullOrBlank() ||
            ...
            Toast.makeText(
                applicationContext,
                "Have you filled all the information?",
                Toast.LENGTH_SHORT
            ).show()
        else {
            dbHelper.saveUserData(
